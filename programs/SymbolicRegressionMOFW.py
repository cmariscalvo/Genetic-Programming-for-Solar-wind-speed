...
def StatsToCsv(StatsDF):
    ...
    StatsDF.to_csv(f'C:\Users\Christian Mariscal\Documents\TFM\\venv_TFM\Stats\MonoStats\\fast\Stats{date}.csv')
...
def sizeAvgMax(stats): 
    ...
    plt.legend()
    plt.savefig(r'C:\Users\Christian Mariscal\Documents\TFM\venv_TFM\results\fast\mono\graphs\sizeAvgMax.png', facecolor='white')
    plt.show()
...
def depthMaxAvg(stats, heightLimit = None):
    ...
    plt.legend()
    plt.savefig(r'C:\Users\Christian Mariscal\Documents\TFM\venv_TFM\results\fast\mono\graphs\depthMaxAvg.png', facecolor='white')
    plt.show()
...
def plotErrorDist(equation, pset, baseline, data, forecast):
    ...
    plt.savefig(r'C:\Users\Christian Mariscal\Documents\TFM\venv_TFM\results\fast\mono\graphs\errorDist.png', facecolor='white')
    plt.show()
...
def absErrMinAvg(stats): 
    ...
    plt.legend()
    plt.savefig(r'C:\Users\Christian Mariscal\Documents\TFM\venv_TFM\results\fast\mono\graphs\absErrMinAvg.png', facecolor='white')
    plt.show()
...
def eaSimpleOr(population, toolbox, cxpb, mutpb, ngen, stats=None,
    ...
    for gen in tqdm(range(1, ngen + 1)):
        ...
        print(f'{popSize};{cxpb};{mtpb};{ngen};{maxHeight};{accelerator};{emperor.__str__()};{bestMetric};', file=open(r'C:\Users\Christian Mariscal\Documents\TFM\venv_TFM\results\fast\mono\genStats\results.txt', 'a'))
...
if __name__ == '__main__': 
    baseline = 54.46280221
    plotErrorDist(emperor.__str__(), pset, baseline, fast_wind, forecast)
