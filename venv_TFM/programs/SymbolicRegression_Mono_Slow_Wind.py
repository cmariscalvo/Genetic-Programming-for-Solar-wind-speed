...
def eaSimpleOr(population, toolbox, cxpb, mutpb, ngen, stats=None,
    ...
    for gen in tqdm(range(1, ngen + 1)):
        ...
        print(f'{popSize};{cxpb};{mtpb};{ngen};{accelerator};{emperor.__str__()};{bestMetric};', file=open(r'C:\Users\Christian Mariscal\Documents\TFM\venv_TFM\results\slow\mono\results.txt', 'a'))
